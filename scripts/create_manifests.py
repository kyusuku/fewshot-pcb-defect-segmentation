...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--visa-root", type=Path, help="Root of prepared VisA or VisA_pytorch data.")
    parser.add_argument(
        "--visa-manifest-csv",
        type=Path,
...
def main() -> None:
    ...
    if args.visa_root:
        ...
        visa_records = split_train_validation(visa_records, val_ratio=args.val_ratio, seed=args.seed)
